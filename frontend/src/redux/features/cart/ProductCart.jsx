      ...
      <div className="h-32 bg-gray-50 my-2 overflow-hidden flex mr-2">
        ...
        <div className="w-[25%] flex items-center justify-end gap-16">
          {quantity == 1 ? (
            <button
              disabled
              className="bg-gray-100 text-gray-400 cursor-not-allowed h-10 w-10 flex items-center justify-center font-bold text-2xl"
            >
              -
            </button>
          ) : (
            <button
              ...
              className="bg-gray-100 cursor-pointer h-10 w-10 flex items-center justify-center font-bold text-2xl"
            >
              -
            </button>
          )}
