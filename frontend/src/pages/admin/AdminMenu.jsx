  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-[96vh]">
        <div className="relative w-[1450px] flex flex-row h-[700px] bg-white rounded shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] ">
          <div
          ...
          <div className="bg-gray-100 h-full w-[230px] overflow">
          ...
          <div className="bg-white h-full w-[1220px] ">
            {page === 1 && <div>{/* <DashBoard /> */}</div>}
            {page === 2 && <div>{/* <Orders /> */}</div>}
