  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center h-[88vh] ">
        <div className="w-[1000px] h-[600px] rounded shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] overflow-">
          <div className="text-center text-2xl font-bold py-4 tracking-wider">
            GET IN TOUCH
          </div>
          <div className="flex justify-between h-[551px] w-full">
            <div className="left w-[50%] m-4 mt-16 text-gray-500">
            ...
            <div className="right w-[50%] m-4 mt-14">
              <h1 className="font-medium text-gray-800 tracking-wide text-xl mb-3">
                Leave us a message
              </h1>
